  ...
  public static void main(String[] args) throws Exception {
    ...
    while (continuar == true) {
      ...
      if (estacionamento.getSize() == 0) {
        ...
        JOptionPane.showMessageDialog(null, "Não há nenhum estacionamento cadastrado, adicione um!", "Waring", JOptionPane.WARNING_MESSAGE);
      ...
      if (opcao == 0) {
        ...
        int number = 0;
        for (Estacionamento estacionament : estacionamento.getList()) {
          JOptionPane.showMessageDialog(null, "Qual estacionamento será alterado? \n" + (number + " - " + estacionament.getNome()));
          number = number + 1;
        }
        ...
        if (sOpc == 0) {
          ...
          String rua = JOptionPane.showInputDialog(null, "Digite as novas informações de endereço: \n Rua do estacionamento: ");
        ...
        if (estacionamento.getList().get(op).getVeiculos().size() != 0) {
          String placa = JOptionPane.showInputDialog(null, "Qual é a placado veículo que será removido do estacionamento?");
          List<String> dados = estacionamento.getList().get(op).removeVeiculos(placa);
          JOptionPane.showMessageDialog(null, "O valor que o motorista deve pagar é de R$" + dados.get(0) + ". A data e hora de entrada foi: " + dados.get(1) + ", e a data e hora de saida foi: " + dados.get(2));
        } else {
